---
layout : default
title :  "Super Dev mode"
---

## How to run Super Dev Mode?

Be aware that the Super Dev Mode is only available GWT 2.5+.
...
In contrast to the “normal” Development Mode, the Super Dev Mode does not start the complete web application for you. Instead you have to run the web application by yourselves. Please refer to [the draft war](draft_war) for details on how to startup the draft war using a servlet container.
